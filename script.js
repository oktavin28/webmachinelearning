    ...
    async function init(){
        ...
        model = await tf.loadLayersModel('http://oktavin28.github.io/tfjs_model/model.json');
        isModelLoaded = true;
        ...
        const word_indexjson = await fetch('http://oktavin28.github.io/word_index.json');
